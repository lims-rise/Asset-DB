            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                ...
                <table class='table table-bordered>'>        
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" name="email" id="email" placeholder="Email" value="<?php echo $email; ?>" /></td></tr>
                    ...
                    <tr><td width='200'>Active Status <?php echo form_error('is_aktif') ?></td><td>
                    ...
                    <tr>
                        <td>Link to Staff</td>
                        <td><?php echo select2_dinamis('staff_id','staff','name','Link to Staff','id',$staff_id ?? ''); ?></td>
                    </tr>
                    <tr><td width='200'>Profile Picture<?php echo form_error('images') ?></td><td> <input type="file" name="images"></td></tr>
                    <tr><td></td><td><input type="hidden" name="id_users" value="<?php echo $id_users; ?>" /> 
                            <button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button> 
                            <a href="<?php echo site_url('user') ?>" class="btn btn-info"><i class="fa fa-arrow-circle-left"></i> Back</a></td></tr>
                </table></form>        </div>
</div>
</div>